...
namespace TArcMap.AddFile.Addmxdfile
{
    /// <summary>
    /// Command that works in ArcMap/Map/PageLayout
    /// </summary>
    [Guid("03a0d893-7712-437b-bd82-1ccb60492fa9")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("TArcMap.AddFile.Addmxdfile.Openmxdfile")]
    public sealed class Openmxdfile : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            pMxdOpenFileDialog.Filter = "µØÍ¼ÎÄµµ(*.mxd)|*.mxd";
