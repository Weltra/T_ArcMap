...
namespace TArcMap.AddFile.Addmdb
{
    /// <summary>
    /// Command that works in ArcMap/Map/PageLayout
    /// </summary>
    [Guid("02703942-7055-4454-b5c0-8abb950b817c")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("TArcMap.AddFile.Addmdb.Openmdb")]
    public sealed class Openmdb : BaseCommand
    {
        ...
        {
            // TODO: Add Openmdb.OnClick implementation
            ...
            //ClearAllData();
            FileClass.AddAllDataset(pWorkspace, mapcontrol as AxMapControl);
        }
