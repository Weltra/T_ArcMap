...
namespace TArcMap.AddFile.Addfiledb
{
    /// <summary>
    /// Command that works in ArcMap/Map/PageLayout
    /// </summary>
    [Guid("e1efdb5b-7f7f-4d2c-9a3d-8cb511a65905")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("TArcMap.AddFile.Openfilegdb")]
    public sealed class Openfilegdb : BaseCommand
    {
        ...
        public Openfilegdb(AxMapControl mapControl)
        {
        ...
        public override void OnClick()
        {
            ...
            FileClass.AddAllDataset(pWorkspac, this.mapControl);
        }
